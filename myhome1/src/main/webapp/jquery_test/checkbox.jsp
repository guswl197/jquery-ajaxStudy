...
<body>
	...
	<input type="checkbox" name="book" id="book3" value="3">아즈카반의죄수들</br>
	<input type="checkbox" name="book" id="book4" value="4">불의잔</br>
	<input type="checkbox" name="book" id="book5" value="5">불사조기사단</br>
	<input type="checkbox" name="book" id="book6" value="6">혼혈왕자</br>
	<input type="checkbox" name="book" id="book17" value="7">죽음의성물</br>
